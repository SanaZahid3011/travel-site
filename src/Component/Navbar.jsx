  ...
  return (
    <nav className="absolute top-9 left-0 w-full flex justify-between items-center p-6 bg-black/4 text-white shadow-lg backdrop-blur-sm z-20">
      ...
      <ul className="hidden lg:block lg:flex lg:space-x-8 ">
        <li className="hover:text-accentt cursor-pointer transition"> <Link to="/home">Home</Link></li>
        <li className="hover:text-accentt cursor-pointer transition">Zayarat pakage </li>
        <li className="hover:text-accentt cursor-pointer transition">Ashura oblige</li>
        <li className="hover:text-accentt cursor-pointer transition">Arbyenn </li>
        ...
        <li className="hover:text-accentt mr-[20px] cursor-pointer transition">Contact</li>
       
      </ul>
      <div className="text-[2rem] sm:mr-[30px] lg:hidden"> <i class="fa-solid fa-bars " onClick={onMenuIcon}></i></div>
